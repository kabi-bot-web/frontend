                                            ...
                                            <Avatar
                                                ...
                                                src={
                                                    value.icon === undefined ? '' :
                                                        `https://cdn.discordapp.com/icons/${value.id}/${value.icon}.${value.icon.startsWith("a_") ? "gif" : "png"}`
                                                }
